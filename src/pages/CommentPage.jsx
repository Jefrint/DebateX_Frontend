...
const CommentPage = () => {
  ...
  // Compute stats to pass as props
  const stats = {
    agreeCount: comments.Agree.length,
    differCount: comments.Differ.length,
    totalLikesAgree: comments.Agree.reduce((sum, c) => sum + c.likes, 0),
    totalLikesDiffer: comments.Differ.reduce((sum, c) => sum + c.likes, 0),
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        <div className="p-4">
          <div className="mb-6">
            <ReactionBar debate={debate} stats={stats} />
          </div>
        ...
        <div className="p-4">
          <div className="mb-6">
            <DifferReactionBar debate={debate} stats={stats} />
          </div>
          <div className="space-y-4">
